...
void analyze_heep(int run_num, int evtNUM)
{
  ...
  TFile *outfile = new TFile(Form("heep_data_%d.root", run_num), "recreate");
  ...
  //Kinematics Quantities
   ...
   TH1F *data_W_2 = new TH1F("data_W2", "Invariant Mass W2", W2_nbins, W2_xmin, W2_xmax);
   TH1F *data_xbj = new TH1F("data_xbj", "x-Bjorken", xbj_nbins, xbj_xmin, xbj_xmax);
   TH1F *data_P_f = new TH1F("data_P_f", "Final Proton Momentum", Pf_nbins, Pf_xmin, Pf_xmax);
   TH1F *data_k_i = new TH1F("data_ki", "Initial e^{-} Momentum", bins, 8., 12.);
   TH1F *data_k_f = new TH1F("data_kf", "Final e^{-} Momentum", kf_nbins, kf_xmin, kf_xmax);
   ...
   TH2F *data_h_xfp_vs_yfp = new TH2F("data_h_xfp_vs_yfp", "X_{fp} vs Y_{fp}", hyfp_nbins, hyfp_xmin, hyfp_xmax, hxfp_nbins, hxfp_xmin, hxfp_xmax);
   TH2F *data_e_xfp_vs_yfp = new TH2F("data_e_xfp_vs_yfp", "X_{fp} vs Y_{fp}", eyfp_nbins, eyfp_xmin, eyfp_xmax, exfp_nbins, exfp_xmin, exfp_xmax);
