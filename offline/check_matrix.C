...
void check_matrix(int runNUM, int evtNUM)
{
  ...
  TString file_path;
  file_path = Form("../../ROOTfiles/coin_replay_production_%d_%d_oldmatrix.root", runNUM, evtNUM);
  //file_path = Form("../../ROOTfiles/coin_replay_production_%d_%d_newmatrix.root", runNUM, evtNUM);
  ...
  TFile *outfile = new TFile(Form("heep_data_%d_%d_oldmatrix_emcut.root", runNUM, evtNUM), "recreate");
