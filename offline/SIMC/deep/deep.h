...
// Thu Feb 15 11:56:58 2018 by ROOT version 6.13/01
// from TTree SNT/SIMTUPLE
// found on file: dummy.root
//////////////////////////////////////////////////////////
...
Int_t deep::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t deep::LoadTree(Long64_t entry)
{
