...
runReportMon="./UTIL_ED/online/Macros/get_${exp}_report.py ${runNum} ${numEvents}"
runCharge="root -l \"${charge_script}(\\\"${exp}\\\", ${runNum}, ${numEvents})\""


#Define smalle e12-10-003 report file directory
reportDir="UTIL_ED/online/CHARGE_REPORTS/${exp}_report_${runNum}.report"
...
# Start analysis and monitoring plots.
{
 ...
 # ln -fs ${rootFile} ${latestRootFile}
  ...
  sleep 2
  eval ${runReportMon}   #execute ./get_deep_report.py
